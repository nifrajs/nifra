...
<div id="app">
  <!-- Inject the global stylesheet verbatim (Svelte's component <style> is scoped). -->
  {@html `<style>${css}</style>`}
  <header class="site">
    <div class="wrap">
      <a href="/" class="logo"><b>nifra</b></a>
      <a href="https://github.com">GitHub</a>
    </div>
  </header>
  <main class="wrap">{@render children()}</main>
  <footer class="site"><div class="wrap">Built with nifra</div></footer>
</div>
