...
// Everything for the "notes" feature lives here: its store, the adapters it uses, and the routes over
// them. Anything this module can reach becomes reach for every route in it, which is exactly why a
...
export const noteRoutes = server()
