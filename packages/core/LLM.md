...
`@nifrajs/core` · `@nifrajs/core/assurance` · `@nifrajs/core/binary` · `@nifrajs/core/budget` · `@nifrajs/core/capabilities` · `@nifrajs/core/causality` · `@nifrajs/core/classification` · `@nifrajs/core/contract` · `@nifrajs/core/cookies` · `@nifrajs/core/diff` · `@nifrajs/core/durable-adapters` · `@nifrajs/core/durable-execution` · `@nifrajs/core/effect-ledger` · `@nifrajs/core/effect-lifecycle` · `@nifrajs/core/effect-scope` · `@nifrajs/core/idempotency` · `@nifrajs/core/idempotency-plugin` · `@nifrajs/core/ledger` · `@nifrajs/core/logger` · `@nifrajs/core/manifest` · `@nifrajs/core/mcp` · `@nifrajs/core/mount` · `@nifrajs/core/node-direct` · `@nifrajs/core/pattern` · `@nifrajs/core/reconciliation-worker` · `@nifrajs/core/reflection` · `@nifrajs/core/response-contract` · `@nifrajs/core/router` · `@nifrajs/core/schema` · `@nifrajs/core/seo` · `@nifrajs/core/server` · `@nifrajs/core/sse` · `@nifrajs/core/transport-codec` · `@nifrajs/core/transport-codec-rich` · `@nifrajs/core/transport-plugin` · `@nifrajs/core/webhook` · `@nifrajs/core/wire` · `@nifrajs/core/ws`
...
- **bytes** _(function)_ — `bytes: (body: BinaryBody, options?: BytesOptions) => BinaryResponse` · from `@nifrajs/core/binary`

_…and 453 more — see [`api-reference.md`](../../api-reference.md#nifrajscore) for the complete list._
