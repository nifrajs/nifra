 ...
 * re-execution. Built from the measured spike in `internal/view-spike/VIEW-SPIKE.md` (0.47 KB
 * vs ~4 KB for the smallest framework island); the size budget is enforced by a test.
 *
