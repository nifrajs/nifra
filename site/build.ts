...
// Crawler surface: robots.txt + the sitemap, served statically at the site root.
cpSync(`${dir}/public/robots.txt`, `${dist}/robots.txt`)
cpSync(`${dir}/public/sitemap.xml`, `${dist}/sitemap.xml`)
